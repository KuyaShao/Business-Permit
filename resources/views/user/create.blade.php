                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="bname" type="text" class="form-control @error('password') is-invalid @enderror" name="bname" required>
                            ...
                            <div class="form-group row">
                                <label for="bname" class="col-md-4 col-form-label text-md-right">Line of Business</label>
