                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.users.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="bname" type="text" class="form-control @error('bname') is-invalid @enderror" name="bname" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="lob" type="text" class="form-control @error('lob') is-invalid @enderror" name="lob" required>
